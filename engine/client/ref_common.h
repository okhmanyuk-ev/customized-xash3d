...
#define GL_LoadTextureInternal( name, pic, flags ) ref.dllFuncs.GL_LoadTextureFromBuffer( (name), (rgbdata_t*)(pic), (texFlags_t)(flags), false )
#define GL_UpdateTextureInternal( name, pic, flags ) ref.dllFuncs.GL_LoadTextureFromBuffer( (name), (rgbdata_t*)(pic), (texFlags_t)(flags), true )
