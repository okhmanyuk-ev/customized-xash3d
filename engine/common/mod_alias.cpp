...
====================
*/
void engine::Mod_LoadAliasModel( model_t *mod, const void *buffer, qboolean *loaded )
{
	...
	pskintype = (daliasskintype_t*)Mod_LoadAllSkins( mod, m_pAliasHeader->numskins, pskintype, m_pAliasHeader );
